...
1. Predictions: Your predictions of the effect of the demographic variable on task performance. Make specific predictions that can be evaluated with a PCA. Explain the reasoning behind your predictions. (You should make these predictions before looking at the data.) 
  
2. Methods: A paragraph describing the methods used to gather the data and perform the PCA. Use the paper from Part I as a guide for how to describe the PCA methods.
...
1. Accuracy, critical thinking, communication; 1 pt 

2. Accuracy, critical thinking, communication; 1 pt

3. Accuracy; 0.25 pts each x 4 = 1 pt

Part II:

1. Critical thinking, communication; 2 pts
    
2. Statistical approach, communication; 2 pts
    
3. Visuals, statistical reporting; 2 pts

4. Statistical reporting, accuracy, communication; 2 pts
    
5. Accuracy, critical thinking, communication; 2 pts
