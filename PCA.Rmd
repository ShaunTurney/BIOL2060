...
For each question, I indicate below the criteria that will be evaluated and the point allocation. The performance descriptions for each criterion are given in the rubric.

Part I:

1. Accuracy, communication; 1 pt 
